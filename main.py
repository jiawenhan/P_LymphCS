...
def train(model_name, data, label_dir, model_path):
    ...
    weights = os.path.join(model_path, 'P_LymphCS.pth')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_name', type=str, default='LpCTransVss', help='DL backbone model')
    ...
    parser.add_argument('--target_category', type=int, default=0, help='target category for GradCam')
