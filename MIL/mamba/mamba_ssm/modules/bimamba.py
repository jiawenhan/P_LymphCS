...
class BiMamba(nn.Module):
    ...
    def forward(self, hidden_states, inference_params=None, rate=10):
        ...
        if self.use_fast_path and inference_params is None:  # Doesn't support outputting the states
            ...
            # Reverse the sequence for the backward BiMamba branch.
            xz_b = xz.flip([-1])
            ...
            # Restore the original token order before merging both branches.
            out_b = out_b.flip([-1])
            out = F.linear(rearrange(out + out_b, "b d l -> b l d"), self.out_proj.weight, self.out_proj.bias)
        else:
            # Split x and z for the two aggregation branches.
            ...
            # Fall back to the native convolution when causal_conv1d is unavailable.
            ...
            # Project the forward branch inputs used by the SSM scan kernel.
